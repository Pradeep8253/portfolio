...
function App() {
  ...
  const location = useLocation(); // ✅ hook ko bahar nikala
  ...
  }, [location.pathname, loading]); // ✅ dono dependencies add ki
  ...
  return (
    <div className={`relative z-0 ${darkMode ? "dark" : ""}`}>
      ...
      {darkMode && (
        <Particles id="tsparticlesbg" options={particlesBgOptions} />
      )}
